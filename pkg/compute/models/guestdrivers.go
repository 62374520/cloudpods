...
type IGuestDriver interface {
	...
	QgaRequestGuestInfoTask(ctx context.Context, userCred mcclient.TokenCredential, host *SHost, guest *SGuest, input *api.ServerQgaGuestInfoTaskInput) (jsonutils.JSONObject, error)
	...
	RequestQgaCommandTest(ctx context.Context, userCred mcclient.TokenCredential, body jsonutils.JSONObject, host *SHost, guest *SGuest) (jsonutils.JSONObject, error)
