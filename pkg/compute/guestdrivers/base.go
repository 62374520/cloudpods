...
func (self *SBaseGuestDriver) QgaRequestGuestExecTest(ctx context.Context, userCred mcclient.TokenCredential, body jsonutils.JSONObject, host *models.SHost, guest *models.SGuest) (jsonutils.JSONObject, error) {
	return nil, httperrors.ErrNotImplemented
}
